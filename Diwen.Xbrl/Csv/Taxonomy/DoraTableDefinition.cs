namespace Diwen.Xbrl.Csv.Taxonomy
{
    ...
    /// <summary/>
    public class DoraTableDefinition
    {
        ...
        public Dictionary<string, DoraTableTemplate> TableTemplates { get; set; }
        ...
        public Dictionary<string, PropertyGroup> Datapoints
        {
            ...
            {
                if (datapoints == null)
                    datapoints = TableTemplates.First().Value.PropertyGroups;
        ...
        /// <summary/>
        public static DoraTableDefinition FromFile(string path)
        {
            using (var stream = new FileStream(path, FileMode.Open, FileAccess.Read))
                return JsonSerializer.Deserialize<DoraTableDefinition>(stream);
        }
    }
}